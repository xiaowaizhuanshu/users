...
public class MessageUtil {
	...
	public static String RCY_EMAILSESSAGE=
		...
		+ "如有任何疑问，可查看博雅彩相关规则，博雅彩网站访问http://www.boyacai.com";
	/*
	 * 邮箱绑定向邮箱发送的内容
	 */
	...
	+"　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　"
	+"博雅彩"+"<br/>"+"客服电话:400-856-1000（工作时间周一至周五9:00-18:00（节假日除外））"+"<br/>"+"(这是一封自动产生的email，请勿回复。)</body></html>";
	...
	+"　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　博雅彩"
	+"<br/>"+"客服电话:400-856-1000（工作时间周一至周五9:00-18:00（节假日除外））"+"<br/>"+"(这是一封自动产生的email，请勿回复。)</body></html>";
}
